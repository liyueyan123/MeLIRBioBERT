...
def get_args():
    parser = ArgumentParser(description="Deep learning model for relevance transfer")
    ...
    parser.add_argument('--dataset', type=str, default='PubmedGeneric', choices=['PubmedGeneric', 'PubmedSpecific', 'CLEF2017_2018', 'CLEF2019'])
    parser.add_argument('--model', type=str, default='BERT-Base', choices=['BERT-Base', 'BERT-Large'])
    ...
    parser.add_argument('--data_dir', default=os.path.join(os.pardir, 'melir-data', 'datasets'))
    parser.add_argument('--word_vectors_dir', default=os.path.join(os.pardir, 'melir-data', 'embeddings', 'word2vec'))
