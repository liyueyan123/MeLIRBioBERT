...
def get_args():
    parser = model.args.get_args()
    parser.add_argument('--model', default=None, type=str, required=True)
    parser.add_argument('--dataset', type=str, default='SST-2', choices=['Pubmed'])
    ...
    parser.add_argument('--warmup-proportion',default=0.1, type=float, help='Proportion of training to perform linear learning rate warmup for')
