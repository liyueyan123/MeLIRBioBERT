...
if __name__ == '__main__':
    args = get_args()  # Set default configuration in args.py
    ...
    if not args.trained_model:
        ...
        num_train_optimization_steps = int(len(train_examples) / args.batch_size / args.gradient_accumulation_steps) * args.epochs
    ...
    if args.fp16:
        ...
        scheduler = WarmupLinearSchedule(optimizer, t_total=num_train_optimization_steps, warmup_steps=args.warmup_proportion * num_train_optimization_steps)
